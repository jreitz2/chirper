...
const NewChirp = ({ isLoggedIn, user, db, storage, isAnon }) => {
      ...
      <Modal isOpen={isOpen} onClose={closeModal}>
        ...
        <form onSubmit={handleSubmit}>
          <textarea
            ...
            value={newChirpText}
            onChange={(e) => setNewChirpText(e.target.value)}
          ></textarea>
          {selectedImage && (
            <img className="selected-image" src={displayImage} alt="selected" />
          )}
